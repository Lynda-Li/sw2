  ...
  <div class="rk-trace-detail flex-v">
    <div class="rk-trace-detail-wrapper clear" v-if="current.endpointNames">
      <h5 class="mb-5 mt-0">
        ...
        <span v-if="current.spansTo" class="vm">{{ current.spansTo.split("http://")[1].substring(current.spansTo.split("http://")[1].indexOf('/')+1) }}</span>
      	<span v-else class="vm">{{ current.endpointNames[0] }}</span>
      </h5>
